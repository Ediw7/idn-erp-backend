...
class ApiReports(http.Controller):
    ...
    @http.route('/api/reports/generate', type='http', auth='public', methods=['POST'], csrf=False)
    ...
    @http.route('/api/reports/generate', type='http', auth='public', methods=['OPTIONS'], csrf=False)
