...
class ApiSetupJenisPajak(http.Controller):
    ...
    def get_jenis_pajak(self, **kw):
        try:
            records = request.env["invoicingbackend.jenis_pajak"].search(
                [], order="kode asc"
            )
            data = []
            for rec in records:
    ...
    def save_jenis_pajak(self, **kw):
        try:
            ...
            return {
                "status": "success",
                "message": "Kode Jenis Pajak berhasil disimpan",
                "id": record.id,
            }
        except Exception as e:
            return {"status": "error", "message": str(e)}
        ...
        try:
            ...
            if record_id:
                ...
                if record.exists():
                    ...
                    return {
                        "status": "success",
                        "message": "Kode Jenis Pajak berhasil dihapus",
                    }
                else:
                    return {"status": "error", "message": "Data tidak ditemukan"}
