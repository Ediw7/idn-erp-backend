...
class SptMasa1111(models.Model):
    ...
    lebih_bayar_pada = fields.Selection(
        [("1.1", "Butir II.D"), ("1.2", "Butir II.F")], string="Lebih Bayar Pada"
    )
    lebih_bayar_oleh = fields.Selection(
        [("2.1", "PKP Pasal 9(4b)"), ("2.2", "Selain PKP Pasal 9(4b)")],
        string="Lebih Bayar Oleh",
    )
    ...
    restitusi_pasal_17c = fields.Selection(
        [("biasa", "Prosedur Biasa"), ("pendahuluan", "Pengembalian Pendahuluan")],
        string="Pasal 17C KUP",
    )
    restitusi_pasal_17d = fields.Selection(
        [("biasa", "Prosedur Biasa"), ("pendahuluan", "Pengembalian Pendahuluan")],
        string="Pasal 17D KUP",
    )
