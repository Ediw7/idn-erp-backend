...
class FakturPajak(models.Model):
    ...
    jenis_transaksi = fields.Char(string='Jenis Transaksi', default='01 - Kepada Bukan Pemungut PPN')
    ...
    line_ids = fields.One2many('invoicingbackend.transaksi_faktur_pajak_line', 'faktur_id', string='Detail Barang')
...
class FakturPajakLine(models.Model):
    ...
    faktur_id = fields.Many2one('invoicingbackend.transaksi_faktur_pajak', string='Faktur Pajak', ondelete='cascade')
