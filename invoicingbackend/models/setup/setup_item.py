...
class Item(models.Model):
    ...
    group_barang_id = fields.Many2one(
        "invoicingbackend.group_barang", string="Group Item", ondelete="set null"
    )
    ...
    perk_penjualan_id = fields.Many2one(
        "invoicingbackend.perkiraan", string="Perk Penjualan", ondelete="set null"
    )
    perk_hpp_id = fields.Many2one(
        "invoicingbackend.perkiraan", string="Perk HPP", ondelete="set null"
    )
